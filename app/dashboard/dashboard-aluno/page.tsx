...
export default function AlunoDashboardPage() {
  ...
  const [proximasReservas, setProximasReservas] = useState<{ id: string; quadra: string; professor: string; data: string; horario: string; tipo: string }[]>([])

  useEffect(() => {
    // TODO: Buscar reservas reais do banco de dados
    ...
    <div className="space-y-6 bg-gray-900 min-h-screen text-white p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Acompanhe seu progresso e prÃ³ximas atividades</p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="text-gray-300">
                  NÃ­vel {arenaPower.nivel} â€¢ {arenaPower.pontos} pontos
                </CardDescription>
              </div>
            </div>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-gray-700">
              ...
              <p className="text-xs text-gray-400">FrequÃªncia</p>
            </div>
            <div className="text-center p-4 bg-gray-800/50 rounded-lg border border-gray-700">
              <div className="flex items-center justify-center mb-2">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-gradient-to-br from-blue-900/50 to-blue-800/50 border-blue-700/50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-blue-300">PrÃ³ximas Aulas</p>
        ...
        <Card className="bg-gradient-to-br from-yellow-900/50 to-orange-800/50 border-yellow-700/50">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-yellow-300">AvaliaÃ§Ã£o</p>
      ...
      <Card className="bg-gray-800/50 border-gray-700">
        <CardHeader>
          <CardTitle className="text-white">PrÃ³ximas Reservas</CardTitle>
