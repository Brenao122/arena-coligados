      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <section id="mvv" aria-labelledby="mvv-heading" className="mb-16 sm:mb-20 md:mb-24 scroll-mt-32">
            <h2
              id="mvv-heading"
              className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tight text-center text-gray-900 mb-8 sm:mb-10 md:mb-12"
            >
            ...
            <div className="grid md:grid-cols-3 gap-6 sm:gap-8" role="list">
              ...
              >
                <div className="p-6 sm:p-8 md:p-10">
                  ...
                  <Target
                    className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 text-[#FF6B47] mb-4 sm:mb-6 relative z-10"
                    aria-hidden="true"
                  />
                  <h3 className="text-2xl sm:text-3xl font-black text-gray-900 mb-3 sm:mb-4 uppercase relative z-10">
                    Missão
                  </h3>
              ...
              >
                <div className="p-6 sm:p-8 md:p-10">
                  <div className="absolute -top-10 -right-10 w-24 h-24 sm:w-32 sm:h-32 bg-[#FFD966] rounded-full opacity-20 blur-2xl group-hover:opacity-40 transition-opacity" />
                  <Eye
                    className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 text-green-600 mb-4 sm:mb-6 relative z-10"
                    aria-hidden="true"
                  />
                  <h3 className="text-2xl sm:text-3xl font-black text-gray-900 mb-3 sm:mb-4 uppercase relative z-10">
                    Visão
              ...
              >
                <div className="p-6 sm:p-8 md:p-10">
                  <div className="absolute -top-10 -right-10 w-24 h-24 sm:w-32 sm:h-32 bg-[#FFD966] rounded-full opacity-20 blur-2xl group-hover:opacity-40 transition-opacity" />
                  <Heart
                    className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 text-red-500 mb-4 sm:mb-6 relative z-10 fill-current"
                    aria-hidden="true"
                  />
                  <h3 className="text-2xl sm:text-3xl font-black text-gray-900 mb-3 sm:mb-4 uppercase relative z-10">
                    Valores
          ...
          <section aria-labelledby="unidades-heading" className="mb-24">
            <h2
              id="unidades-heading"
              className="text-3xl sm:text-4xl md:text-5xl font-black text-center text-gray-900 mb-12 uppercase"
            >
              Nossas Unidades
            </h2>
            <div className="grid md:grid-cols-2 gap-8" role="list">
              ...
              >
                ...
                <div className="bg-gradient-to-br from-[#FF6B47] to-[#ff8c6b] text-white rounded-[2rem] p-10 relative overflow-hidden h-full flex flex-col">
                  ...
                  <p className="text-white/90 mb-4 font-bold uppercase tracking-wide text-sm relative z-10">
                    5 quadras profissionais | Beach Tennis, Vôlei e Futevôlei
                  </p>
                  <address className="text-sm text-white/80 not-italic font-medium relative z-10 mb-6">
                    Parque Amazônia, Goiânia - GO
                  </address>
                  <button
                    onClick={() =>
                      window.open("https://api.whatsapp.com/message/CI3R2YERLZ3MG1?autoload=1&app_absent=0", "_blank")
                    }
              ...
              >
                ...
                <div className="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-[2rem] p-10 relative overflow-hidden h-full flex flex-col">
                  <div className="absolute -bottom-12 -left-12 w-48 h-48 bg-[#FFD966] rounded-full blur-3xl opacity-30 animate-pulse-glow" />
                  <MapPin className="h-14 w-14 text-white mb-6 relative z-10" aria-hidden="true" />
                  <h3 className="text-4xl font-black text-white mb-3 uppercase relative z-10">Vila Rosa</h3>
                  <p className="text-white/90 mb-4 font-bold uppercase tracking-wide text-sm relative z-10">
                    4 quadras equipadas | Beach Tennis, Vôlei e Futevôlei
                  </p>
                  <address className="text-sm text-white/80 not-italic font-medium relative z-10 mb-6">
                    Setor Vila Rosa, Goiânia - GO
                  </address>
                  <button
                    onClick={() =>
                      window.open(
                        "https://api.whatsapp.com/send/?phone=5562995797965&text&type=phone_number&app_absent=0",
                        "_blank",
                      )
                    }
                    className="mt-auto bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white font-black py-3 px-6 rounded-full transition-all hover:scale-105 flex items-center justify-center gap-2 relative z-10 border-2 border-white/40"
          ...
          <section id="time" aria-labelledby="team-heading" className="text-center scroll-mt-32">
            <div className="relative overflow-hidden rounded-3xl p-12 md:p-16 bg-gradient-to-br from-[#FF6B47] via-[#ff8c6b] to-[#FFD966] border-4 border-white/20 shadow-2xl">
              ...
              <div
                className="absolute bottom-10 left-10 w-64 h-64 bg-white rounded-full blur-3xl opacity-30 animate-pulse-glow"
                style={{ animationDelay: "1s" }}
              />

              <Users
                className="h-20 w-20 text-white mx-auto mb-8 relative z-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.8)]"
                aria-hidden="true"
              />

              <h2
                id="team-heading"
                className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-6 uppercase relative z-10 drop-shadow-[0_0_20px_rgba(255,255,255,0.6)]"
                style={{ textShadow: "3px 3px 0 rgba(0,0,0,0.2), -1px -1px 0 rgba(255,255,255,0.5)" }}
              >
                Nosso Time
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto" role="list">
                <article
                  className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-8 border-4 border-[#FF6B47] shadow-[0_0_30px_rgba(255,107,71,0.6)] group hover:scale-105 hover:shadow-[0_0_50px_rgba(255,107,71,0.9)] transition-all relative overflow-hidden"
                  role="listitem"
                >
                  ...
                  <Zap
                    className="h-12 w-12 text-[#FF6B47] mx-auto mb-4 relative z-10 drop-shadow-[0_0_10px_rgba(255,107,71,0.8)]"
                    aria-hidden="true"
                  />
                  <Trophy
                    className="h-10 w-10 text-[#FFD966] mx-auto mb-4 relative z-10 drop-shadow-[0_0_10px_rgba(255,217,102,0.8)]"
                    aria-hidden="true"
                  />
                  <h3 className="text-2xl font-black text-white mb-2 uppercase relative z-10 tracking-wider">
                    Gustavo Oliveira
                  </h3>
                  <p className="text-[#FF6B47] font-black uppercase text-sm tracking-widest relative z-10">
                    Co-fundador & Diretor
                  </p>
                </article>

                <article
                  className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-8 border-4 border-green-500 shadow-[0_0_30px_rgba(34,197,94,0.6)] group hover:scale-105 hover:shadow-[0_0_50px_rgba(34,197,94,0.9)] transition-all relative overflow-hidden"
                  role="listitem"
                >
                  <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                  <Zap
                    className="h-12 w-12 text-green-500 mx-auto mb-4 relative z-10 drop-shadow-[0_0_10px_rgba(34,197,94,0.8)]"
                    aria-hidden="true"
                  />
                  <Trophy
                    className="h-10 w-10 text-[#FFD966] mx-auto mb-4 relative z-10 drop-shadow-[0_0_10px_rgba(255,217,102,0.8)]"
                  ...
                  <p className="text-green-500 font-black uppercase text-sm tracking-widest relative z-10">
                    Sócio Investidor
                  </p>
                </article>
              </div>
