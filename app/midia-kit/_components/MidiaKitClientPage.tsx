...
export default function MidiaKitClientPage() {
  ...
  return (
    <>
      ...
      <main
        id="main-content"
        className="min-h-screen bg-gradient-to-b from-orange-50 to-white pt-32 pb-20 relative overflow-hidden"
      >
        {/* Decorative circles */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
          <header className="text-center mb-16 sm:mb-24 animate-fade-in">
            <div className="inline-flex items-center gap-3 mb-6 px-6 py-3 bg-white rounded-full shadow-lg">
              ...
              <span className="text-xs sm:text-sm font-bold uppercase tracking-widest text-gray-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
              ...
              >
                <span className="flex items-center justify-center gap-3">
                  ...
                  <ExternalLink
                    className="h-5 w-5 group-hover:rotate-45 transition-transform duration-300"
                    aria-hidden="true"
                  />
                </span>
              </Button>
          ...
          <section aria-labelledby="logo-heading" className="mb-16 sm:mb-24">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8" role="list">
              <figure
                className="group relative bg-white p-8 sm:p-10 rounded-[2rem] shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                role="listitem"
              >
              ...
              <figure
                className="group relative bg-gradient-to-br from-gray-900 to-gray-800 p-8 sm:p-10 rounded-[2rem] shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                role="listitem"
              >
              ...
              <figure
                className="group relative bg-gradient-to-br from-orange-100 to-yellow-100 p-8 sm:p-10 rounded-[2rem] shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 sm:col-span-2 md:col-span-1"
                role="listitem"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6" role="list">
              {cores.map((cor) => (
                <article key={cor.hex} className="group" role="listitem">
                  ...
                  <p className="text-xs sm:text-sm text-gray-600 font-mono mb-1">{cor.hex}</p>
                  <p className="text-xs text-gray-500 font-mono">RGB {cor.rgb}</p>
                </article>
              ))}
            </div>
          </section>
          ...
          <section aria-labelledby="stats-heading" className="mb-16 sm:mb-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8" role="list">
              <article
                className="group bg-white p-6 sm:p-8 rounded-[2rem] shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 text-center"
                role="listitem"
              >
                ...
                <div
                  className="text-4xl sm:text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B47] to-[#ff8566] mb-3"
              ...
              >
                ...
                <div
                  className="text-4xl sm:text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#10b981] to-[#34d399] mb-3"
              ...
              >
                ...
                <div
                  className="text-4xl sm:text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FFD966] to-[#ffd24d] mb-3"
              ...
              >
                ...
                <div
                  className="text-4xl sm:text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B47] to-[#FFD966] mb-3"
                  aria-label="12 colaboradores"
                >
                  12
                </div>
          ...
          <section
            ...
            className="relative bg-gradient-to-br from-[#FF6B47] to-[#ff8566] p-8 sm:p-16 rounded-[2rem] shadow-2xl text-center overflow-hidden"
          >
            ...
            <div className="relative z-10">
              <h2
                id="contact-heading"
                className="text-3xl sm:text-4xl md:text-5xl font-black uppercase mb-4 sm:mb-6 text-white"
              >
                Vamos Juntos?
              </h2>
